...
const QUICK_LINKS = [
  ...
  { icon: Mail, label: 'Email us', value: 'excel@theexcelagency.com', href: 'mailto:excel@theexcelagency.com' },
    ...
    <div>
      ...
      <section className="pt-20 pb-16 bg-white dark:bg-[#0a0a0a]">
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <p className="text-[15px] text-[#555555] dark:text-[#888888] leading-[1.7] max-w-[580px] mb-8">
