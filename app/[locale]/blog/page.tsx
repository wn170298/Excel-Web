...
export default function BlogPage({ params: { locale } }: { params: { locale: string } }) {
  ...
  return (
    <div>
      {/* Header */}
      <section className="max-w-[1200px] mx-auto px-6 pt-28 pb-12">
        <div className="max-w-[600px]">
          <span className="text-label mb-5 block">Resources</span>
          <h1 className="text-[48px] font-semibold tracking-[-0.03em] text-[#0a0a0a] mb-4">
            Marketing insights.
          </h1>
          <p className="text-[17px] text-[#555555] leading-[1.65]">
